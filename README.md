...
<h3> Creating the Domain Controller VM (Server 2019)<h3>
<br /> 1. I downloaded Oracle VM to host my virtual machines. I had two different operating matchines within Oracle (Windows 10 ISO and Windows Server 2019 ISO) 
 ...
 4. I got the Server set up and named, I downloaded and installed Active Directory and created a domain.
